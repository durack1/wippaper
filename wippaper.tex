...
organisational and funding constraints. In
Section~\ref{sec:principles}, the principles and scientific rationale
underlying the requirements for global data infrastructure are
articulated. In Section~\ref{sec:dreq} the CMIP6 Data Request is
...
\item With greater complexity and a globally distributed data
  ...
  \item In 2016 at the WIP's request, the CMIP6 Data Node
    ...
    and organizing coordinated version upgrades across the federation.
  \end{itemize}
...
There is an emerging trend at some centres to add resources that
combine archival and analysis capabilities (e.g., NCAR's
\urlref{https://goo.gl/sYTxC2}{CMIP Analysis Platform}). This too will
relieve the pressure on data networks, as the analysis will be carried
out close to the data.
