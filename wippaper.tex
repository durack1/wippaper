...
for the Programme.
\pllabel{RC2-12}
A map of sites participating in the ESGF are shown in in
...
itself is a complex and delicate component to manage.
...
\item With greater complexity and a globally distributed data
  ...
  \item One of the WIP's first acts was to consider three phases in
    ...
    \item The implementation is in the hands of the infrastructure
      ...
      \citep{ref:williamsetal2015}, but also related projects like Earth
...
\item\label{broad} With the basic fact of anthropogenic climate change
  ...
  \item In addition to the specialists in Earth system science -- who
    ...
    issues \citep{ref:mossetal2010}. This confronts us with a
...
\item\label{analysis} With the expectation that CMIP DECK experiment
  ...
  \item Typical multi-model analysis has hitherto taken the
    ...
    \citep{ref:knutti2010} has been called into question and there is now
...
\item As the experimental design of CMIP has grown in complexity,
  ...
  \item Alongside the intellectual contribution to model development,
    ...
    centers in computing and data processing, which is both burdensome
    \pllabel{RC1-11}
    ...
    \citep[see Table~1 in][]{ref:eyringetal2016a} begins to grapple
    with this issue, but the costs still need to be measured and
    recorded. To begin documenting these costs for CMIP6, the
    ``Computational Performance'' MIP project (CPMIP)
    \citep{ref:balajietal2017} has been established, which will
    \pllabel{RC1-13}
    measure, among other things, throughput (simulated years per day)
    and cost (core-hours and joules per simulated year) as a function
    of model resolution and complexity. Tools for estimating data
    volumes have also developed, see Section~\ref{sec:data-request}
    below.
  \end{itemize}
\item\label{cmplx} Experimental specifications have become ever more
 ...
 \item Several modeling centers have encountered this problem in
   ...
   \citep{ref:juckesetal2015}, and crossover requirements between the
   endorsed MIPs and the DECK \citep{ref:eyringetal2016a} . Moreover,
