...
\abstract{
  ...
  data infrastructure evolution that follow from the blurring of
...
\item With greater complexity and a globally distributed data
  ...
  \item One of the WIP's first acts was to separate the process of
   ...
   \item At the WIP's request, the CMIP6 Data Node Operations Team
     ...
     specifying what versions of the toolchain are run at every site
     at any given time, and organizing coordinated version upgrades
...
\item\label{broad} With the basic fact of anthropogenic climate change
  ...
  a substantial body of work has begun to emerge to examine climate
  impacts. This has brought many new user communities into play.
  \begin{itemize}
  \item The center of gravity for the community of data analysts is no
...
\item\label{analysis} With the expectation that CMIP DECK experiment
  ...
  \item To that end, there is now a requirement to enable through the
    ...
    (the WIP recognized that this may not be achievable at the
    beginning of CMIP6).
  \end{itemize}
